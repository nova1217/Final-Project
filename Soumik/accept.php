...
<p><h2 align="center">Verify Customer Order</h2></p>
    <div class="container">
...
<?php
    foreach($result as $row)
    {
        ...
        echo '<td align="center" colspan="2"><a href="acception.php"><button type="button" class="btn btn-warning">Accept</button></td>';  
        echo '</tr>';
    }  
?>
