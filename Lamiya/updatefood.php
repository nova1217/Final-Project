<?php require_once 'Controllers/foodcontroller.php';?>
...
<fieldset>
         ...
         <legend align="center"><h1><b>UPDATE INFO</b></h1></legend>
		 ...
		 <form action= "" method="post" onsubmit="return validate()">
			<table align="center">
				<tr>
					...
					<td>:<input type="text" id="FoodName" name="FoodName"  ><span id="err_F_Name"></span></td>
