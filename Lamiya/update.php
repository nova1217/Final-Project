...
<fieldset>
         ...
         <legend align="center"><h1><b>Update Profile</b></h1></legend>
		 ...
		 <form action= "" method="post" onsubmit="return validate()">
			<table align="center">
				...
				<td><span>Permanent Address</span></td>
					...
					<td>:<input type="radio" id="Male" name="Gender" ><span>Male</span><br><input type="radio" id="Female" name="Gender" ><span>Female</span><span id="err_Gender"></span></td>
				</tr>
